...
func DBInsert(response *Info) {
	...
	for _, r := range response.data {
		result, err = db.Exec("Insert Into manager(user_id,first_name,last_name,biin,email, phone,passwrd,type)  Values ($1,$2,$3,$4,$5,$6,$7,$8)",
...
func main() {
	...
	go func() {
		for d := range msgs {
			...
			result = 
			DBInsert(&result)
			fmt.Println("You have inserted the value")
		}
	}()
